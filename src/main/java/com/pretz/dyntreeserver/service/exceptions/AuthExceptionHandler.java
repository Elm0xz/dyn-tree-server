...
public class AuthExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<String> handleAuthException(AuthException aEx) {
        return new ResponseEntity<>(AuthException.authExceptionMsg + aEx.userName, new HttpHeaders(), HttpStatus.UNAUTHORIZED);
    }
    ...
    protected ResponseEntity<Object> handleUserCreationFailException(UserAlreadyCreatedException uEx) {
        return new ResponseEntity<Object>(UserAlreadyCreatedException.userAlreadyCreatedExceptionMsg + uEx.userName, new HttpHeaders(), HttpStatus.INTERNAL_SERVER_ERROR);
    }
